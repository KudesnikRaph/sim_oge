...
// Простой мок Footer, чтобы не было ошибок с изображением
const Footer = () => (
  <footer className="footer">
    ...
    <div className="footer-column dev-column">
      ...
      <ul className="footer-list">
        <li><a href="https://github.com/KudesnikRaph ">Даниил К.</a></li>
        <li><a href="https://github.com/driveGosling ">Иоан П.</a></li>
      </ul>
    </div>
    <div className="footer-column">
      <h3 className="footer-title">Источники</h3>
      <ul className="footer-list">
        <li><a href="https://uchitel.pro/ история-россии-предмет">Учитель</a></li>
        <li><a href="https://www.universalinternetlibrary.ru/book/46892/ogl.shtml?ysclid=m9mus68489801928238/ ">Электронная библиотека</a></li>
        <li><a href="https://www.rusempire.ru/istoriya-rossii-kratko.html/ ">История государства россиит</a></li>
      </ul>
    </div>
  </footer>
);
...
describe('Footer Component', () => {
  ...
  test('должен отображать источники с правильными ссылками', () => {
    ...
    const source3 = screen.getByRole('link', { name: 'История государства россиит' });
  ...
  test('должен отображать все три колонки футера', () => {
    const columns = screen.getAllByRole('heading', { level: 3 }); // h3 — заголовки колонок
