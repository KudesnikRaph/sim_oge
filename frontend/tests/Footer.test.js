import React from 'react'; // ⬅️ Обязательно добавь эту строку
import { render, screen } from '@testing-library/react';
import Footer from '../src/components/Footer';

jest.mock('../src/components/Footer.css', () => ({}));
jest.mock('../src/assets/logo.png', () => null);
...
describe('Footer Component', () => {
  ...
  test('должен отображать источники с правильными ссылками', () => {
    ...
    const source3 = screen.getByRole('link', { name: 'История государства россии' });
